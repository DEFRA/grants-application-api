...
```bash
docker build --target development --no-cache --tag grants-application-api:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 grants-application-api:development
```
...
```bash
docker build --no-cache --tag grants-application-api .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 grants-application-api
```
